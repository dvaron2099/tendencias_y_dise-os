...
puts "..."
category_torero_drill = Category.create(category_type: "Torero de dril")
puts "..."
...
#  availability: true,
#  gender: gentleman,
#  category: category_jean,
#  colors: [grey, light_blue],
#  sizes: [size_28, size_30, size_32, size_34, size_36, size_38]
#)
...
product_1.colors << grey
product_1.colors << light_blue

product_1.sizes << size_28
product_1.sizes << size_30
product_1.sizes << size_32
product_1.sizes << size_34
product_1.sizes << size_36
product_1.sizes << size_38
...
product_3 = Product.create(
  ...
  category: category_short_men,
  colors: [black, grey],
  sizes: [size_28, size_30, size_32, size_34]
)
...
product_4 = Product.create(
  ...
  availability: false,
  gender: lady,
  category: category_skirt_short,
  colors: [purple, green],
  sizes: [size_6, size_8, size_10, size_12, size_14, size_16]
)
...
product_5 = Product.create(
  ...
  availability: true,
  gender: lady,
  category: category_short_drill,
  colors: [dark_blue, black],
  sizes: [size_18, size_20, size_22, size_24]
)
...
product_20.photos.attach(io: file, filename: "942720d428b5fe48ef669d6f3b84d99e.jpg" , content_type: "image/jpg")
